...
db = client["PowerBi"]
collection = db["offredetudes"]

file_path = r"C:\Users\khmir\Desktop\ETL_DigitalCook_PFE\data\offredetudes.json"
...
print(f"{inserted_count} nouvelles offredetudes insérées.")
