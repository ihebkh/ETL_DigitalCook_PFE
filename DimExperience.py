...
# Fonction pour insérer les données d'expérience dans PostgreSQL avec secteur_fk
def insert_experience_with_fk(codeexperience, role, entreprise, start_year, start_month, end_year, end_month, pays, secteur_fk, ville, type_contrat):
...
# Extraction des expériences et insertion dans PostgreSQL
def extract_experiences_and_insert():
                        ...
                        if secteur_data:
                            for job in secteur_data.get('jobs', []):
                                ...
                                if secteur_fk:
                                    ...
                                    # Insérer les données dans PostgreSQL avec secteur_fk
                                    insert_experience_with_fk(
                                        codeexperience,
                                        role,
                                        entreprise,
                                        du_year,
...
extract_experiences_and_insert()
